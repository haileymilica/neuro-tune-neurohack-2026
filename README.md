...
2. build Arduino circuit, this is a simple, grounded, 3 LED circuit, Green led goes to digital pin 8, yellow to Digital pin 10 and red to digital pin 9. I have the Arduino uno. The code is programmed to work on that
